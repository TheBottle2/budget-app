...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: '#6C63FF', padding: 12, paddingTop: 8, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  headerBaslik: { color: '#fff', fontSize: 18, fontWeight: 'bold' },
  cikisBtn: { color: '#fff', fontSize: 13, opacity: 0.8 },
  aySecici: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: '#6C63FF', paddingBottom: 12 },
  ayBtn: { paddingHorizontal: 16 },
  ayBtnText: { color: '#fff', fontSize: 26, fontWeight: '300' },
  ayMetin: { color: '#fff', fontSize: 16, fontWeight: '600', minWidth: 140, textAlign: 'center' },
  liste: { padding: 12 },
  listBaslikSatir: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 },
  listBaslik: { fontSize: 15, fontWeight: 'bold', color: '#333' },
  tumunuGor: { fontSize: 12, color: '#6C63FF', fontWeight: '600' },
  bosText: { textAlign: 'center', color: '#aaa', marginTop: 30, fontSize: 14 },
  ekleBtn: { backgroundColor: '#6C63FF', margin: 12, borderRadius: 12, padding: 14, alignItems: 'center' },
  ekleBtnText: { color: '#fff', fontSize: 16, fontWeight: 'bold' },
});
